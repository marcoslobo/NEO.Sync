...
{
    [DbContext(typeof(EvoLuaContext))]
    partial class EvoLuaContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EvoLua.Blockchain.Models.Assets", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("EvoLua.Blockchain.Models.Transfers", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnName("id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EvoLua.Blockchain.Models.Wallet", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("EvoLua.Blockchain.Models.Assets", b =>
                {
                    b.HasOne("EvoLua.Blockchain.Models.Wallet", "AdminWallet")
                        .WithMany()
                    ...
                    b.HasOne("EvoLua.Blockchain.Models.Wallet", "OwnerWallet")
                        .WithMany()
            ...
            modelBuilder.Entity("EvoLua.Blockchain.Models.Transfers", b =>
                {
                    b.HasOne("EvoLua.Blockchain.Models.Wallet", "AddressFrom")
                        .WithMany("TransfersOut")
                        .HasForeignKey("AddressFromId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EvoLua.Blockchain.Models.Wallet", "AddressTo")
                        .WithMany("TransfersIn")
                        .HasForeignKey("AddressToId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EvoLua.Blockchain.Models.Assets", "Asset")
                        .WithMany()
